/**
 * Vanguard-WMS · Phase 5: Advanced Efficiency Suite
...
int main() {
  ...
  ╚██╗ ██╔╝██╔══██║██║╚██╗██║██║   ██║██║   ██║██╔══██║██╔══██╗██║  ██║
   ╚████╔╝ ██║  ██║██║ ╚████║╚██████╔╝╚██████╔╝██║  ██║██║  ██║██████╔╝
    ╚═══╝  ╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝
  WMS Logic Engine  ·  Phase 5: Advanced Efficiency Suite  ·  C++20 / Crow
)" << "\n";
    ...
    try {
        std::cout << "[Engine] Booting Phase 5 Efficiency Suite...\n";
        ...
        std::cout << "[Engine] ✓ AVL Tree        h=" << s.avl_height << " n=" << s.avl_size << "\n"
                  ...
                  << "[Engine] ✓ Order Heap      active=" << s.heap_size << "\n"
                  << "[Engine] ✓ Huffman Coder   ready (O(n log n) encode)\n"
                  << "[Engine] ✓ TSP Solver      ready (Held-Karp n<15, Nearest-Neighbor n≥15)\n\n";
    } catch (const std::exception& e) {
